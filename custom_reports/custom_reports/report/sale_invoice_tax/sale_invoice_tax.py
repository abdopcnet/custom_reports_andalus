...
def execute(filters=None):
	...
	# Mandatory: Only submitted invoices
	where_conditions.append("`tabSales Invoice`.docstatus = 1")
	# Exclude Cancelled and Draft statuses
	where_conditions.append("`tabSales Invoice`.status NOT IN ('Cancelled', 'Draft')")
